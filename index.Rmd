...
colnames(crono) <- paste(7:11, ("Ago"), sep = " ")
crono[1, 1] <- c("Reprodutibilidade + Apresentação da disciplina.")
crono[2, 1] <- c("Dados abertos: organização, metadados, pré-registro")
crono[1, 2] <- c("Organização local de projetos: pastas, scripts limpos, etc")
...
crono[1, 5] <- c("Publicação em acesso aberto: Preprints, tipos de acesso aberto")
