...
Para que o git funcione corretamente, pode ser necessário informar manualmente o caminho onde o git vive no seu computador para o RStudio. Para fazer isso abra o RStudio, em seguida acesse a aba *Seção*, vá até *opções globais* e informe o caminho para o git no seu computador, como mostrado na imagem abaixo.

```{r echo=FALSE,eval=TRUE}
knitr::include_graphics(here::here("figs/git-rstudio-path.png"))
```
